<template>
  <main class="main-app">
    ...
    <div class="button-containe common-container">
      ...
      <Button size="large" icon="bars-progress">Icon</Button><br /><br />
    </div>
    ...
    <div class="tooltip-container common-container">
      <Tooltip content="triggered by rl" placement="right-end" :trigger="trigger" ref="tooltipRef"
               :open-delay="1000" :close-delay="1000">
        <img alt="Vue log" class="logo" src="./assets//logo.svg" width="30" height="30" />
        <template #content>
    ...
    <h2>Dropdown 下拉菜单</h2>
    <div class="tooltip-container common-container">
      <Dropdown placement="bottom" :trigger="dropdownTrigger" :menu-options="menuOptions">
        <img alt="snow log" class="logo" src="./assets//snow-icon.svg" width="30" height="30" />
      </Dropdown>
    </div>
    ...
    <h2>Select 选择器</h2>
    <div class="icon-container common-container">
      <Select v-model="selectVal" placeholder="请选择" :options="selectOptions"/>
    </div>
...
const menuOptions: MenuOption[] = [
  ...
  {
    key: 4, label: 'item4', disabled: true
  },
  {
    key: 5, label: 'item5', divided: true
  },
]
// dropdown 组件相关 end
...
onMounted(() => {
  ...
  createMessage({ message: '谢谢你的观看', duration: 0, type: 'danger', showClose: true })
})
